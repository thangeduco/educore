...
exports.PgUserEventLogsRepository = void 0;
 ...
 */
class PgUserEventLogsRepository {
    async createUserEventLog(input) {
        try {
            const query = `
      ...
      `;
            ...
            await db_postgres_1.pool.query(query, values);
        }
        catch (err) {
            console.error('[PgUserEventLogsRepository][createUserEventLog] ❌ Lỗi khi insert user_event_logs', err);
            throw err;
        }
    }
}
exports.PgUserEventLogsRepository = PgUserEventLogsRepository;
