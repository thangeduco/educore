...
exports.bmUserEventLogsController = void 0;
const user_log_uc_1 = require("../../../application/BM/use-cases/bm-user-logs/user-log.uc");
const bm_pg_user_event_logs_repository_1 = require("../../../infrastructure/BM/bm-pg-user-event-logs.repository");
const middware_service_1 = require("../../services/middware.service");
// Khởi tạo repository & use case
const userEventLogsRepo = new bm_pg_user_event_logs_repository_1.PgUserEventLogsRepository();
const userLogUC = new user_log_uc_1.UserLogUC(userEventLogsRepo);
exports.bmUserEventLogsController = {
    /**
     * API ghi log sự kiện người dùng
     * POST /bm/user-event-logs
     */
    async createUserEventLog(req, res) {
        try {
            const body = (req.body || {});
            ...
            const clientIp = (0, middware_service_1.getClientIp)(req);
            const input = {
                tenant_code: body.tenant_code || null,
                user_id: body.user_id !== undefined && body.user_id !== null
                    ? Number(body.user_id)
                    : null,
                ...
                event_value: body.event_value !== undefined && body.event_value !== null
                    ? String(body.event_value)
                    : null,
                object_type: body.object_type ?? null,
                object_id: body.object_id !== undefined && body.object_id !== null
                ...
                client_screen_width: body.client_screen_width !== undefined &&
                    body.client_screen_width !== null
                    ? Number(body.client_screen_width)
                    : null,
                client_screen_height: body.client_screen_height !== undefined &&
